...
seeded width jitter, heads seated in a croze below a chime, iron hoops
lofted on the stave faces, a bung) then the shipped pipeline: unique-cell
...
the croze instead of leaving triangular slots at every joint.
...
| --- | --- | --- |
| Base triangles | 6000–8500 | 7216 / 7216 / 7216 |
| LOD1 ratio | 0.32–0.62 of base | 0.5000 / 0.5000 / 0.5000 |
| LOD2 ratio | 0.10–0.35 of base | 0.2198 / 0.2198 / 0.2198 |
| Materials | exactly 2 distinct; ≥400 wood, ≥200 metal faces | 2 slots; 2512 / 1440 |
| UVs | in `0..1`, AABB overlap ≤ 1e-5 | in range, overlap 0 |
| Outer AABB | (0.722, 0.714, 0.880) m ± 0.015 | (0.7220, 0.7142, 0.8800), zmin 0 |
| Collider tris | ≤ 400 | 238 |
| Export | written, size > 0 | 544140 / 544140 / 544124 bytes |
...
| Axis | Declared | Measured (all three) |
| --- | --- | --- |
| Head-croze rim BVH gap | ≤ 0.010 m | 0.00698 |
...
| 17 | Joint fit: head-croze gap (`--float-head`) |

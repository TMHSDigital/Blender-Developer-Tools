...
examples/<name>/               - Runnable smoke-gated examples, 38 total (+ gallery.json)
...
`--output`. All thirty-eight run headless on Blender 4.5 LTS and 5.1 in `blender-smoke.yml`;

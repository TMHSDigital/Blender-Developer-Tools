...
pump (stacked wooden plinth, two-diameter column, gooseneck spout,
pump head, forked handle, wooden grip) then the shipped pipeline:
unique-cell UVs, Cycles high-to-low normal bake, LOD
...
| --- | --- | --- |
| Base triangles | 1080–1240 | 1164 / 1164 / 1164 |
| LOD1 ratio | 0.32–0.62 of base | 0.5000 / 0.5000 / 0.5000 |
| LOD2 ratio | 0.10–0.35 of base | 0.2199 / 0.2199 / 0.2148 |
| Materials | exactly 2 distinct, ≥24 metal faces | 2 slots, 222 metal |
| UVs | in `0..1`, AABB overlap ≤ 1e-5 | in range, overlap 0 |
| Outer AABB | (0.610, 0.364, 1.049) m ± 0.01 | (0.6100, 0.3639, 1.0491), zmin 0 |
| Collider tris | ≤ 160 | 110 |
| Export | written, size > 0 | 85944 / 85944 / 85936 bytes |

...
(square post, pyramidal cap, cross-arm, iron shoe, bands, and two
hitching rings) then the shipped pipeline: unique-cell UVs, Cycles
...
| --- | --- | --- |
| Base triangles | 780–920 | 848 / 848 / 848 |
| LOD1 ratio | 0.32–0.62 of base | 0.5000 / 0.5000 / 0.5000 |
| LOD2 ratio | 0.10–0.35 of base | 0.2193 / 0.2193 / 0.1958 |
| Materials | exactly 2 distinct, ≥24 metal faces | 2 slots, 262 metal |
| UVs | in `0..1`, AABB overlap ≤ 1e-5 | in range, overlap 0 |
| Outer AABB | (0.460, 0.194, 1.260) m ± 0.01 | (0.4600, 0.1943, 1.2600), zmin 0 |
| Collider tris | ≤ 180 | 144 |
| Export | written, size > 0 | 73164 / 73164 / 73160 bytes |
...
Export byte counts differ by 4 B on 5.2.1 (glTF serializer), not a
gated axis.

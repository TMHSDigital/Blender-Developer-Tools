...
A showcase piece, not an example. Procedural staved barrel (bulged staves,
four iron hoops, top and bottom heads) then the shipped pipeline:
...
| --- | --- | --- |
| Base triangles | 4200–4450 | 4312 / 4312 / 4312 |
| LOD1 ratio | 0.32–0.62 of base | 0.5000 / 0.5000 / 0.5000 |
| LOD2 ratio | 0.10–0.35 of base | 0.2199 / 0.2199 / 0.2199 |
| Materials | exactly 2 distinct, ≥16 metal hoop faces | 2 slots, 88 hoop faces |
| UVs | in `0..1`, AABB overlap ≤ 1e-5 | in range, overlap 0 |
| Outer AABB | (0.719, 0.719, 0.880) m ± 0.01 | (0.7194, 0.7194, 0.8800), zmin 0 |
| Collider tris | ≤ 400 | 372 |
| Export | written, size > 0 | 327564 / 327564 / 327556 bytes |
...
| 5 | Material count ≠ 2 distinct slots, or hoop faces missing |
| 6 | UVs outside 0..1 |

...
A showcase piece, not an example. Procedural coopered bucket (overlapping
staves, sealed bottom, iron hoops, ears, rope bail) then the shipped
...
| --- | --- | --- |
| Base triangles | 4150–4400 | 4272 / 4272 / 4272 |
| LOD1 ratio | 0.32–0.62 of base | 0.5000 / 0.5000 / 0.5000 |
| LOD2 ratio | 0.10–0.35 of base | 0.2196 / 0.2196 / 0.2196 |
| Materials | exactly 3 distinct, ≥24 metal, ≥12 rope | 3 slots, 222 metal, 72 rope |
| UVs | in `0..1`, AABB overlap ≤ 1e-5 | in range, overlap 0 |
| Outer AABB | (0.402, 0.345, 0.544) m ± 0.01 | (0.4020, 0.3449, 0.5439), zmin 0 |
| Collider tris | ≤ 420 | 390 |
| Export | written, size > 0 | 330476 / 330476 / 330464 bytes |

DECIMATE COLLAPSE triangle counts are **not** identical across series —
the gate is a ratio band, not an exact count. Bake pixels are stochastic;
...
| 5 | Material count ≠ 3 distinct slots, or metal/rope faces missing |
| 6 | UVs outside 0..1 |

...
| Materials | exactly 2 distinct, ≥24 hay, ≥24 twine | 2 slots, 1404 hay, 304 twine |
...
| **Belt wrap zmin** | each belt shell ≤ 0.006 m | 0.002846 both |
| **Belt seat depth** | every station in [0.002, 0.020] m | 0.00400..0.00903 over 20/20 stations, both belts |
| **Mirror symmetry** | belts and loops matched within 5e-4 m | 0.000000 |
| **Loaf mirror** | every loaf vertex has an X-mirror partner within 2e-4 m | 0.000071 |
...
| Collider tris | ≤ 400 | 120 |
| Export | written, size > 0 | 197504 / 197504 / 197496 bytes |
...
that code. All seven proven on 4.5.11, 5.1.2 and 5.2.1.
...
is an 8 × 10 mm cord, and the hitch loop's tube is sized from the same
`TWINE_T`. The earlier note here, that the surface belonged to the

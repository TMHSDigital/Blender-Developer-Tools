...
examples/<name>/               - Runnable smoke-gated examples, 18 total (+ gallery.json)
...
`--output`. All eighteen run headless on Blender 4.5 LTS and 5.1 in `blender-smoke.yml`;

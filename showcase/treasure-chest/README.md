...
A showcase piece, not an example. Procedural slatted treasure chest
(hollow body, open lid, iron bands, corner brackets, lock plate) then
...
| --- | --- | --- |
| Base triangles | 5600–5850 | 5724 / 5724 / 5724 |
| LOD1 ratio | 0.32–0.62 of base | 0.5000 / 0.5000 / 0.5000 |
| LOD2 ratio | 0.10–0.35 of base | 0.2198 / 0.2198 / 0.2198 |
| Materials | exactly 2 distinct, ≥24 metal faces | 2 slots, 180 metal |
| UVs | in `0..1`, AABB overlap ≤ 1e-5 | in range, overlap 0 |
| Outer AABB | (0.776, 0.549, 0.631) m ± 0.01 | (0.7760, 0.5486, 0.6312), zmin 0 |
| Collider tris | ≤ 160 | 138 |
| Export | written, size > 0 | 416656 / 416656 / 416644 bytes |

...
def render_still(sc, heroes, path, engine):
    ...
    light("Key", (-3.5, -4.5, 5.5), 330.0, 4.5, (1.0, 0.96, 0.9), (0, 0, 0.5))
    light("Fill", (4.5, -4.0, 2.2), 70.0, 9.0, (0.75, 0.85, 1.0), (0, 0, 0.5))
    light("Rim", (0.5, 4.0, 4.5), 300.0, 4.0, (0.6, 0.78, 1.0), (0, 0, 0.6))
    light("Wedge", (0.6, 5.2, 0.9), 230.0, 5.0, (1.0, 0.76, 0.5), (0.3, 7.5, 2.4))
